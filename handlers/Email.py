...
class Email(Handler):
	def get(self):
		...
		for g in overdueGear:
			...
			destination_address = [g.holder.email, 'rorybrown@college.harvard.edu', 'danielbridgwater@college.harvard.edu', 'njoseph@college.harvard.edu', 'wbloxham@college.harvard.edu', 'rradovanovic@college.harvard.edu']
